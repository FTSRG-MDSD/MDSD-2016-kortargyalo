...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.kortargyalo.drones.simulation.dronesSimulation.TaskInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskInstanceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskInstance_task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskInstance_task_feature", "_UI_TaskInstance_type"),
				 DronesSimulationPackage.Literals.TASK_INSTANCE__TASK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskInstance_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskInstance_state_feature", "_UI_TaskInstance_type"),
				 DronesSimulationPackage.Literals.TASK_INSTANCE__STATE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DronesSimulationPackage.Literals.TASK_INSTANCE__ROLE_INSTANCES);
		}
	...
	public String getText(Object object) {
		TaskState labelValue = ((TaskInstance)object).getState();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DronesSimulationPackage.Literals.TASK_INSTANCE__ROLE_INSTANCES,
				 DronesSimulationFactory.eINSTANCE.createRoleInstance()));
	}
