 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.kortargyalo.drones.behavior.dronesBehavior.impl.SequenceImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceImpl extends StatementImpl implements Sequence {
	/**
	...
	protected EClass eStaticClass() {
		return DronesBehaviorPackage.Literals.SEQUENCE;
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, DronesBehaviorPackage.SEQUENCE__STATEMENTS);
		}
		return statements;
	}
