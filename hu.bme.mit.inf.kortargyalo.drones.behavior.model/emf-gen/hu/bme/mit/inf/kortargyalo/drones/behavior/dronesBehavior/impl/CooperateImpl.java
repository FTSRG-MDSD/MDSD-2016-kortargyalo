...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cooperate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class CooperateImpl extends AtomicStatementImpl implements Cooperate {
	/**
	...
	protected EClass eStaticClass() {
		return DronesBehaviorPackage.Literals.COOPERATE;
	}
		...
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DronesBehaviorPackage.COOPERATE__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public void setRole(Role newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DronesBehaviorPackage.COOPERATE__ROLE, oldRole, role));
	}
