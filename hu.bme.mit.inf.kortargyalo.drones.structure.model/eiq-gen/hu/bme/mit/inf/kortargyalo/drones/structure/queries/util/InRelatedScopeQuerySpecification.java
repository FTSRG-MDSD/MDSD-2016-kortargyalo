...
final class InRelatedScopeQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  ...
  private static class LazyHolder {
    private final static InRelatedScopeQuerySpecification INSTANCE = make();
    
    public static InRelatedScopeQuerySpecification make() {
      return new InRelatedScopeQuerySpecification();					
    }
  }
