...
public final class NonpositiveWeightQuerySpecification extends BaseGeneratedEMFQuerySpecification<NonpositiveWeightMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link NonpositiveWeightQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NonpositiveWeightQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static NonpositiveWeightQuerySpecification INSTANCE = new NonpositiveWeightQuerySpecification();
