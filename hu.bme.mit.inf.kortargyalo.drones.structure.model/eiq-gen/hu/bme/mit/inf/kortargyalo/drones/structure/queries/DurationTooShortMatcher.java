...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.durationTooShort pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DurationTooShortMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * {@literal @}Constraint(
 ...
 * 	check(StartTimeout {@literal >}= Duration);
 * }
 * </pre></code>
 * 
 * @see DurationTooShortMatch
 * @see DurationTooShortProcessor
 * @see DurationTooShortQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DurationTooShortMatcher extends BaseMatcher<DurationTooShortMatch> {
  /**
   ...
   * 
   */
  public static DurationTooShortMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    DurationTooShortMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new DurationTooShortMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(DurationTooShortMatcher.class);
   ...
   */
  @Deprecated
  public DurationTooShortMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public DurationTooShortMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a DurationTooShortMatch object.
   * 
   */
  public Collection<DurationTooShortMatch> getAllMatches(final CooperativeAction pAction) {
   ...
   * @param pAction the fixed value of pattern parameter Action, or null if not bound.
   * @return a match represented as a DurationTooShortMatch object, or null if no match is found.
   * 
   */
  public DurationTooShortMatch getOneArbitraryMatch(final CooperativeAction pAction) {
   ...
   * 
   */
  public void forEachMatch(final CooperativeAction pAction, final IMatchProcessor<? super DurationTooShortMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final CooperativeAction pAction, final IMatchProcessor<? super DurationTooShortMatch> processor) {
   ...
   * 
   */
  public DurationTooShortMatch newMatch(final CooperativeAction pAction) {
    return DurationTooShortMatch.newMatch(pAction);
  }
   ...
   * 
   */
  public static IQuerySpecification<DurationTooShortMatcher> querySpecification() throws IncQueryException {
