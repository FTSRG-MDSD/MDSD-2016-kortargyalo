...
/**
 * A match processor tailored for the hu.bme.mit.inf.kortargyalo.drones.structure.queries.scanningCapability pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ScanningCapabilityProcessor implements IMatchProcessor<ScanningCapabilityMatch> {
  /**
  ...
  @Override
  public void process(final ScanningCapabilityMatch match) {
