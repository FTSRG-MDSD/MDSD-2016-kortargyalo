...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.nonpositiveBatteryCapacity pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link NonpositiveBatteryCapacityMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * {@literal @}Constraint(
 ...
 * 	check(Capacity {@literal <}= 0);
 * }
 * </pre></code>
 * 
 * @see NonpositiveBatteryCapacityMatch
 * @see NonpositiveBatteryCapacityProcessor
 * @see NonpositiveBatteryCapacityQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class NonpositiveBatteryCapacityMatcher extends BaseMatcher<NonpositiveBatteryCapacityMatch> {
  /**
   ...
   * 
   */
  public static NonpositiveBatteryCapacityMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    NonpositiveBatteryCapacityMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new NonpositiveBatteryCapacityMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(NonpositiveBatteryCapacityMatcher.class);
   ...
   */
  @Deprecated
  public NonpositiveBatteryCapacityMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public NonpositiveBatteryCapacityMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a NonpositiveBatteryCapacityMatch object.
   * 
   */
  public Collection<NonpositiveBatteryCapacityMatch> getAllMatches(final DroneType pDroneType) {
   ...
   * @param pDroneType the fixed value of pattern parameter DroneType, or null if not bound.
   * @return a match represented as a NonpositiveBatteryCapacityMatch object, or null if no match is found.
   * 
   */
  public NonpositiveBatteryCapacityMatch getOneArbitraryMatch(final DroneType pDroneType) {
   ...
   * 
   */
  public void forEachMatch(final DroneType pDroneType, final IMatchProcessor<? super NonpositiveBatteryCapacityMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final DroneType pDroneType, final IMatchProcessor<? super NonpositiveBatteryCapacityMatch> processor) {
   ...
   * 
   */
  public NonpositiveBatteryCapacityMatch newMatch(final DroneType pDroneType) {
    return NonpositiveBatteryCapacityMatch.newMatch(pDroneType);
  }
   ...
   * 
   */
  public static IQuerySpecification<NonpositiveBatteryCapacityMatcher> querySpecification() throws IncQueryException {
