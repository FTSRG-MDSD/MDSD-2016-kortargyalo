...
/**
 * A pattern-specific query specification that can instantiate NegativeCostProvidedCapabilityMatcher in a type-safe way.
 * 
 * @see NegativeCostProvidedCapabilityMatcher
 * @see NegativeCostProvidedCapabilityMatch
 * 
 */
@SuppressWarnings("all")
public final class NegativeCostProvidedCapabilityQuerySpecification extends BaseGeneratedEMFQuerySpecification<NegativeCostProvidedCapabilityMatcher> {
  private NegativeCostProvidedCapabilityQuerySpecification() {
   ...
   * 
   */
  public static NegativeCostProvidedCapabilityQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected NegativeCostProvidedCapabilityMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return NegativeCostProvidedCapabilityMatcher.on(engine);
  }
  
  @Override
  public NegativeCostProvidedCapabilityMatch newEmptyMatch() {
    return NegativeCostProvidedCapabilityMatch.newEmptyMatch();
  }
  
  @Override
  public NegativeCostProvidedCapabilityMatch newMatch(final Object... parameters) {
    return NegativeCostProvidedCapabilityMatch.newMatch((hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.ProvidedCapability) parameters[0], (hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.Capability) parameters[1], (hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.DroneType) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NegativeCostProvidedCapabilityQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NegativeCostProvidedCapabilityQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static NegativeCostProvidedCapabilityQuerySpecification INSTANCE = new NegativeCostProvidedCapabilityQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static NegativeCostProvidedCapabilityQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.kortargyalo.drones.structure.queries.negativeCostProvidedCapability";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern negativeCostProvidedCapability";
      		                            }
      		...
      		annotation.addAttribute("message", "Energy consumption of provided capability $Capability.name$ of $DroneType.name$ must not be negative.");
