...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.negativeCostProvidedCapability pattern,
 * to be used in conjunction with {@link NegativeCostProvidedCapabilityMatcher}.
 * 
...
public abstract class NegativeCostProvidedCapabilityMatch extends BasePatternMatch {
  ...
  private NegativeCostProvidedCapabilityMatch(final ProvidedCapability pProvidedCapability, final Capability pCapability, final DroneType pDroneType) {
  ...
  public List<String> parameterNames() {
    return NegativeCostProvidedCapabilityMatch.parameterNames;
  }
  ...
  @Override
  public NegativeCostProvidedCapabilityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NegativeCostProvidedCapabilityMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NegativeCostProvidedCapabilityMatch other = (NegativeCostProvidedCapabilityMatch) obj;
  ...
  @Override
  public NegativeCostProvidedCapabilityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NegativeCostProvidedCapabilityMatch newEmptyMatch() {
   ...
   * 
   */
  public static NegativeCostProvidedCapabilityMatch newMutableMatch(final ProvidedCapability pProvidedCapability, final Capability pCapability, final DroneType pDroneType) {
   ...
   * 
   */
  public static NegativeCostProvidedCapabilityMatch newMatch(final ProvidedCapability pProvidedCapability, final Capability pCapability, final DroneType pDroneType) {
    return new Immutable(pProvidedCapability, pCapability, pDroneType);
  }
  
  private static final class Mutable extends NegativeCostProvidedCapabilityMatch {
  ...
  private static final class Immutable extends NegativeCostProvidedCapabilityMatch {
