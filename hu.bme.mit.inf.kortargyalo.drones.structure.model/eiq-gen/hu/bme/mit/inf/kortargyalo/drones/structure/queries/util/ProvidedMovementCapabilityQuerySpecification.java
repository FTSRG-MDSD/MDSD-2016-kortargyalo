...
/**
 * A pattern-specific query specification that can instantiate ProvidedMovementCapabilityMatcher in a type-safe way.
 * 
 * @see ProvidedMovementCapabilityMatcher
 * @see ProvidedMovementCapabilityMatch
 * 
 */
@SuppressWarnings("all")
final class ProvidedMovementCapabilityQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  private ProvidedMovementCapabilityQuerySpecification() {
   ...
   * 
   */
  public static ProvidedMovementCapabilityQuerySpecification instance() throws IncQueryException {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link ProvidedMovementCapabilityQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link ProvidedMovementCapabilityQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ProvidedMovementCapabilityQuerySpecification INSTANCE = new ProvidedMovementCapabilityQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ProvidedMovementCapabilityQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.bme.mit.inf.kortargyalo.drones.structure.queries.providedMovementCapability";
    }
      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_Capability), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "MovementCapability")));
      		bodies.add(body);
      	}
