...
public final class NegativeEnergyConsumptionQuerySpecification extends BaseGeneratedEMFQuerySpecification<NegativeEnergyConsumptionMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link NegativeEnergyConsumptionQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NegativeEnergyConsumptionQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static NegativeEnergyConsumptionQuerySpecification INSTANCE = new NegativeEnergyConsumptionQuerySpecification();
