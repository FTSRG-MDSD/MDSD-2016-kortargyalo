...
public final class NotOneMovementCapabilityProvidedQuerySpecification extends BaseGeneratedEMFQuerySpecification<NotOneMovementCapabilityProvidedMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link NotOneMovementCapabilityProvidedQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NotOneMovementCapabilityProvidedQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static NotOneMovementCapabilityProvidedQuerySpecification INSTANCE = new NotOneMovementCapabilityProvidedQuerySpecification();
