...
public final class NonpositiveStartTimeoutQuerySpecification extends BaseGeneratedEMFQuerySpecification<NonpositiveStartTimeoutMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link NonpositiveStartTimeoutQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link NonpositiveStartTimeoutQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static NonpositiveStartTimeoutQuerySpecification INSTANCE = new NonpositiveStartTimeoutQuerySpecification();
