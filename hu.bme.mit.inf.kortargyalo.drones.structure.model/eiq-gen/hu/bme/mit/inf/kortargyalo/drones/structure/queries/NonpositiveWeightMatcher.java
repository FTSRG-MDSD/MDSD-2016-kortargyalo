...
/**
 * Generated pattern matcher API of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.nonpositiveWeight pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link NonpositiveWeightMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * {@literal @}Constraint(
 ...
 * 	check(Weight {@literal <}= 0);
 * }
 * </pre></code>
 * 
 * @see NonpositiveWeightMatch
 * @see NonpositiveWeightProcessor
 * @see NonpositiveWeightQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class NonpositiveWeightMatcher extends BaseMatcher<NonpositiveWeightMatch> {
  /**
   ...
   * 
   */
  public static NonpositiveWeightMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    NonpositiveWeightMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new NonpositiveWeightMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(NonpositiveWeightMatcher.class);
   ...
   */
  @Deprecated
  public NonpositiveWeightMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public NonpositiveWeightMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a NonpositiveWeightMatch object.
   * 
   */
  public Collection<NonpositiveWeightMatch> getAllMatches(final DroneType pDroneType) {
   ...
   * @param pDroneType the fixed value of pattern parameter DroneType, or null if not bound.
   * @return a match represented as a NonpositiveWeightMatch object, or null if no match is found.
   * 
   */
  public NonpositiveWeightMatch getOneArbitraryMatch(final DroneType pDroneType) {
   ...
   * 
   */
  public void forEachMatch(final DroneType pDroneType, final IMatchProcessor<? super NonpositiveWeightMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final DroneType pDroneType, final IMatchProcessor<? super NonpositiveWeightMatch> processor) {
   ...
   * 
   */
  public NonpositiveWeightMatch newMatch(final DroneType pDroneType) {
    return NonpositiveWeightMatch.newMatch(pDroneType);
  }
   ...
   * 
   */
  public static IQuerySpecification<NonpositiveWeightMatcher> querySpecification() throws IncQueryException {
