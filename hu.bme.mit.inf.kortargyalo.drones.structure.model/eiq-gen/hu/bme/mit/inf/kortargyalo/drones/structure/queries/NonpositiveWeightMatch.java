...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.nonpositiveWeight pattern,
 * to be used in conjunction with {@link NonpositiveWeightMatcher}.
 * 
...
public abstract class NonpositiveWeightMatch extends BasePatternMatch {
  private DroneType fDroneType;
  
  private static List<String> parameterNames = makeImmutableList("DroneType");
  
  private NonpositiveWeightMatch(final DroneType pDroneType) {
  ...
  public List<String> parameterNames() {
    return NonpositiveWeightMatch.parameterNames;
  }
  ...
  @Override
  public NonpositiveWeightMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NonpositiveWeightMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NonpositiveWeightMatch other = (NonpositiveWeightMatch) obj;
  ...
  @Override
  public NonpositiveWeightQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NonpositiveWeightMatch newEmptyMatch() {
   ...
   * 
   */
  public static NonpositiveWeightMatch newMutableMatch(final DroneType pDroneType) {
   ...
   * 
   */
  public static NonpositiveWeightMatch newMatch(final DroneType pDroneType) {
    return new Immutable(pDroneType);
  }
  
  private static final class Mutable extends NonpositiveWeightMatch {
  ...
  private static final class Immutable extends NonpositiveWeightMatch {
