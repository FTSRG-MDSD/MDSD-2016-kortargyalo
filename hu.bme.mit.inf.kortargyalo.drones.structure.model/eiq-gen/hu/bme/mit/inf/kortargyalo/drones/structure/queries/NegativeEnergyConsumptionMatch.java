...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.negativeEnergyConsumption pattern,
 * to be used in conjunction with {@link NegativeEnergyConsumptionMatcher}.
 * 
...
public abstract class NegativeEnergyConsumptionMatch extends BasePatternMatch {
  private DroneType fDroneType;
  
  private static List<String> parameterNames = makeImmutableList("DroneType");
  
  private NegativeEnergyConsumptionMatch(final DroneType pDroneType) {
  ...
  public List<String> parameterNames() {
    return NegativeEnergyConsumptionMatch.parameterNames;
  }
  ...
  @Override
  public NegativeEnergyConsumptionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NegativeEnergyConsumptionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NegativeEnergyConsumptionMatch other = (NegativeEnergyConsumptionMatch) obj;
  ...
  @Override
  public NegativeEnergyConsumptionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NegativeEnergyConsumptionMatch newEmptyMatch() {
   ...
   * 
   */
  public static NegativeEnergyConsumptionMatch newMutableMatch(final DroneType pDroneType) {
   ...
   * 
   */
  public static NegativeEnergyConsumptionMatch newMatch(final DroneType pDroneType) {
    return new Immutable(pDroneType);
  }
  
  private static final class Mutable extends NegativeEnergyConsumptionMatch {
  ...
  private static final class Immutable extends NegativeEnergyConsumptionMatch {
