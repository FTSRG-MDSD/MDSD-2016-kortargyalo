...
final class ChildScopeQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link ChildScopeQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link ChildScopeQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static ChildScopeQuerySpecification INSTANCE = new ChildScopeQuerySpecification();
