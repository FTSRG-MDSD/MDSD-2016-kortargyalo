...
public final class DurationTooShortQuerySpecification extends BaseGeneratedEMFQuerySpecification<DurationTooShortMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link DurationTooShortQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link DurationTooShortQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static DurationTooShortQuerySpecification INSTANCE = new DurationTooShortQuerySpecification();
