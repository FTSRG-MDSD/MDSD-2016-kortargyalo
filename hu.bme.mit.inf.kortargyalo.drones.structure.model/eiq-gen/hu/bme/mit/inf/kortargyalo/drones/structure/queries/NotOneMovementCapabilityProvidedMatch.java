...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.kortargyalo.drones.structure.queries.notOneMovementCapabilityProvided pattern,
 * to be used in conjunction with {@link NotOneMovementCapabilityProvidedMatcher}.
 * 
...
public abstract class NotOneMovementCapabilityProvidedMatch extends BasePatternMatch {
  private DroneType fDroneType;
  
  private static List<String> parameterNames = makeImmutableList("DroneType");
  
  private NotOneMovementCapabilityProvidedMatch(final DroneType pDroneType) {
  ...
  public List<String> parameterNames() {
    return NotOneMovementCapabilityProvidedMatch.parameterNames;
  }
  ...
  @Override
  public NotOneMovementCapabilityProvidedMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NotOneMovementCapabilityProvidedMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NotOneMovementCapabilityProvidedMatch other = (NotOneMovementCapabilityProvidedMatch) obj;
  ...
  @Override
  public NotOneMovementCapabilityProvidedQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NotOneMovementCapabilityProvidedMatch newEmptyMatch() {
   ...
   * 
   */
  public static NotOneMovementCapabilityProvidedMatch newMutableMatch(final DroneType pDroneType) {
   ...
   * 
   */
  public static NotOneMovementCapabilityProvidedMatch newMatch(final DroneType pDroneType) {
    return new Immutable(pDroneType);
  }
  
  private static final class Mutable extends NotOneMovementCapabilityProvidedMatch {
  ...
  private static final class Immutable extends NotOneMovementCapabilityProvidedMatch {
