...
public class DroneTypeImpl extends MinimalEObjectImpl.Container implements DroneType {
	...
	/**
	 * The cached value of the '{@link #getMovementCapability() <em>Movement Capability</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected ProvidedCapability movementCapability;
	...
	public ProvidedCapability getMovementCapability() {
		if (movementCapability != null && movementCapability.eIsProxy()) {
			InternalEObject oldMovementCapability = (InternalEObject)movementCapability;
			movementCapability = (ProvidedCapability)eResolveProxy(oldMovementCapability);
			if (movementCapability != oldMovementCapability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DronesStructurePackage.DRONE_TYPE__MOVEMENT_CAPABILITY, oldMovementCapability, movementCapability));
			}
		}
	 ...
	 * @generated
	 */
	public void setMovementCapability(ProvidedCapability newMovementCapability) {
		ProvidedCapability oldMovementCapability = movementCapability;
		movementCapability = newMovementCapability;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DronesStructurePackage.DRONE_TYPE__MOVEMENT_CAPABILITY, oldMovementCapability, movementCapability));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DronesStructurePackage.DRONE_TYPE__PROVIDED_CAPABILITIES:
				...
				return;
			case DronesStructurePackage.DRONE_TYPE__MOVEMENT_CAPABILITY:
				setMovementCapability((ProvidedCapability)newValue);
				return;
			case DronesStructurePackage.DRONE_TYPE__DIMENSION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case DronesStructurePackage.DRONE_TYPE__PROVIDED_CAPABILITIES:
				...
				return;
			case DronesStructurePackage.DRONE_TYPE__MOVEMENT_CAPABILITY:
				setMovementCapability((ProvidedCapability)null);
				return;
			case DronesStructurePackage.DRONE_TYPE__DIMENSION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DronesStructurePackage.DRONE_TYPE__MOVEMENT_CAPABILITY:
				return movementCapability != null;
			case DronesStructurePackage.DRONE_TYPE__DIMENSION:
