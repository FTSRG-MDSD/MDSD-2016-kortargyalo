...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCooperativeActionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Cooperative Action feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCooperativeActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_cooperativeAction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_cooperativeAction_feature", "_UI_Role_type"),
				 DronesStructurePackage.Literals.ROLE__COOPERATIVE_ACTION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DronesStructurePackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DronesStructurePackage.Literals.ROLE__REQUIRED_CAPABILITIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DronesStructurePackage.Literals.ROLE__REQUIRED_CAPABILITIES,
				 DronesStructureFactory.eINSTANCE.createRequiredCapability()));
	}
