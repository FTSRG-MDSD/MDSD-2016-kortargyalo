...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.Drone} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DroneItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Drone_startPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Drone_startPosition_feature", "_UI_Drone_type"),
				 DronesStructurePackage.Literals.DRONE__START_POSITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Drone_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Drone_name_feature", "_UI_Drone_type"),
				 DronesStructurePackage.Literals.DRONE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Dronetype feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDronetypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Drone_dronetype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Drone_dronetype_feature", "_UI_Drone_type"),
				 DronesStructurePackage.Literals.DRONE__DRONETYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DronesStructurePackage.Literals.DRONE__START_POSITION);
		}
