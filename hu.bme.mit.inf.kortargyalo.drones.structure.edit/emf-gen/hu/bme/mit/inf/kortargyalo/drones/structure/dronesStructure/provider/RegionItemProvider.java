...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider extends AABBItemProvider {
	/**
	...
	protected void addTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Region_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Region_tasks_feature", "_UI_Region_type"),
				 DronesStructurePackage.Literals.REGION__TASKS,
				 true,
				 false,
				 true,
				 null,
