...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.inf.kortargyalo.drones.structure.dronesStructure.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addActionToPerformPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_region_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_region_feature", "_UI_Task_type"),
				 DronesStructurePackage.Literals.TASK__REGION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DronesStructurePackage.Literals.TASK__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Action To Perform feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addActionToPerformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_actionToPerform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_actionToPerform_feature", "_UI_Task_type"),
				 DronesStructurePackage.Literals.TASK__ACTION_TO_PERFORM,
				 true,
				 false,
				 true,
				 null,
