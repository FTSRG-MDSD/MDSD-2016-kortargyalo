...
public abstract class ObservationImpl extends MinimalEObjectImpl.Container implements Observation {
	...
	protected EClass eStaticClass() {
		return DronesSimulationPackage.Literals.OBSERVATION;
	}
	...
	public void setTime(long newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DronesSimulationPackage.OBSERVATION__TIME, oldTime, time));
	}
