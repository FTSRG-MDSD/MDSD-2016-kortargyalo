...
class CollisionHelper {
	...
	def static boolean doDronesCollide(double p1positionx, double p1positiony, double p1positionz, double p1dimensionx, double p1dimensiony, double p1dimensionz, double p2positionx, double p2positiony, double p2positionz, double p2dimensionx, double p2dimensiony, double p2dimensionz) {
