...
public final class LeftSceneQuerySpecification extends BaseGeneratedEMFQuerySpecification<LeftSceneMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link LeftSceneQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link LeftSceneQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static LeftSceneQuerySpecification INSTANCE = new LeftSceneQuerySpecification();
