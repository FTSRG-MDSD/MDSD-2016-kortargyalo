...
/**
 * Pattern-specific match representation of the hu.bme.mit.inf.kortargyalo.drones.simulation.model.queries.droneBatteryDepleted pattern,
 * to be used in conjunction with {@link DroneBatteryDepletedMatcher}.
 * 
...
public abstract class DroneBatteryDepletedMatch extends BasePatternMatch {
  private DroneInstance fDrone;
  
  private static List<String> parameterNames = makeImmutableList("drone");
  
  private DroneBatteryDepletedMatch(final DroneInstance pDrone) {
    this.fDrone = pDrone;
  }
  ...
  public List<String> parameterNames() {
    return DroneBatteryDepletedMatch.parameterNames;
  }
  ...
  @Override
  public DroneBatteryDepletedMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof DroneBatteryDepletedMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    DroneBatteryDepletedMatch other = (DroneBatteryDepletedMatch) obj;
  ...
  @Override
  public DroneBatteryDepletedQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DroneBatteryDepletedMatch newEmptyMatch() {
   ...
   * 
   */
  public static DroneBatteryDepletedMatch newMutableMatch(final DroneInstance pDrone) {
   ...
   * 
   */
  public static DroneBatteryDepletedMatch newMatch(final DroneInstance pDrone) {
    return new Immutable(pDrone);
  }
  
  private static final class Mutable extends DroneBatteryDepletedMatch {
  ...
  private static final class Immutable extends DroneBatteryDepletedMatch {
