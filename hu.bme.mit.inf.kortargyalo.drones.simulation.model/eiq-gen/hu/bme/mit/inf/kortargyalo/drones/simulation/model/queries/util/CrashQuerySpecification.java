...
public final class CrashQuerySpecification extends BaseGeneratedEMFQuerySpecification<CrashMatcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link CrashQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link CrashQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static CrashQuerySpecification INSTANCE = new CrashQuerySpecification();
