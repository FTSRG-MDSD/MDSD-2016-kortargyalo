      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_18_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "position")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_20_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "position")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_22_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "position")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_24_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "dimension")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_26_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "dimension")));
      		...
      		new TypeConstraint(body, new FlatTuple(var_charger, var__virtual_28_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://inf.mit.bme.hu/kortargyalo/dronesStructure", "AABB", "dimension")));
