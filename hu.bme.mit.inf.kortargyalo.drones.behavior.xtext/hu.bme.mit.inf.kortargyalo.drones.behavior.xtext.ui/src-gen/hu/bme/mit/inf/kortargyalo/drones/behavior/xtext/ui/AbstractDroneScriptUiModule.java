...
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ide.contentassist.antlr.DroneScriptParser;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ide.contentassist.antlr.PartialDroneScriptContentAssistParser;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ide.contentassist.antlr.internal.InternalDroneScriptLexer;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ui.contentassist.DroneScriptProposalProvider;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ui.labeling.DroneScriptDescriptionLabelProvider;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ui.labeling.DroneScriptLabelProvider;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ui.outline.DroneScriptOutlineTreeProvider;
import hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.ui.quickfix.DroneScriptQuickfixProvider;
...
/**
 * Manual modifications go to {@link DroneScriptUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractDroneScriptUiModule extends DefaultXbaseUiModule {

	public AbstractDroneScriptUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(hu.bme.mit.inf.kortargyalo.drones.behavior.xtext.parser.antlr.internal.InternalDroneScriptLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalDroneScriptLexer.class).toProvider(LexerProvider.create(InternalDroneScriptLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return DroneScriptLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(DroneScriptDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return DroneScriptOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return DroneScriptQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return DroneScriptProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialDroneScriptContentAssistParser.class;
	}
