	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getDronesBehaviorAccess().getAlternatives_3(), "rule__DronesBehavior__Alternatives_3");
					...
					put(grammarAccess.getDronesBehaviorAccess().getGroup_3_0(), "rule__DronesBehavior__Group_3_0__0");
					put(grammarAccess.getDronesBehaviorAccess().getGroup_3_0_2(), "rule__DronesBehavior__Group_3_0_2__0");
					...
					put(grammarAccess.getDronesBehaviorAccess().getImportsAssignment_0(), "rule__DronesBehavior__ImportsAssignment_0");
					put(grammarAccess.getDronesBehaviorAccess().getScenarioAssignment_2(), "rule__DronesBehavior__ScenarioAssignment_2");
					put(grammarAccess.getDronesBehaviorAccess().getSignalsAssignment_3_0_1(), "rule__DronesBehavior__SignalsAssignment_3_0_1");
					put(grammarAccess.getDronesBehaviorAccess().getSignalsAssignment_3_0_2_1(), "rule__DronesBehavior__SignalsAssignment_3_0_2_1");
					put(grammarAccess.getDronesBehaviorAccess().getScriptsAssignment_3_1(), "rule__DronesBehavior__ScriptsAssignment_3_1");
