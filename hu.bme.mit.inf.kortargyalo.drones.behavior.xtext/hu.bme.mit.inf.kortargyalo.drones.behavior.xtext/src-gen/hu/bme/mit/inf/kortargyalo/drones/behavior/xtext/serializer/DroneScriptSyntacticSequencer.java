...
public class DroneScriptSyntacticSequencer extends AbstractSyntacticSequencer {

	protected DroneScriptGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (DroneScriptGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) 'charge' (rule start)
	 *     (rule start) (ambiguity) 'cooperate' 'on' task=[Task|ID]
	 ...
	 *     (rule start) (ambiguity) 'move' 'to' destination=Position
	 ...
	 *     (rule start) (ambiguity) 'scan' (rule start)
	 *     (rule start) (ambiguity) 'send' 'map' 'to' recipent=[Drone|ID]
	 *     (rule start) (ambiguity) 'send' signal=[Signal|QualifiedName]
